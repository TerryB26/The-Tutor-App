...
import { Box, Typography, Grid, Dialog, DialogTitle, DialogContent, DialogContentText, Divider, IconButton, Card, CardContent } from '@mui/material';
import { MdTrendingUp, MdPerson, MdAttachMoney } from 'react-icons/md';
import { IoCloseCircleOutline } from 'react-icons/io5';
import TutoringSessionsTable from '../components/Results/TutoringSessionsTable';
...
const Dashboard = () => {
  ...
  return (
    <Box display="flex">
      <Sidebar />
      <Box component="main" sx={{ flexGrow: 1, p: 3, ml: 0 }} ref={dashboardRef}>
